...
import { BlockchainServiceFactory, SolanaBlockchainService } from '../services/blockchainService';
import { NetworkService } from '../services/networkService';
import { NetworkFamily } from '../types/networks';

describe('Solana Blockchain Service Tests', () => {
  ...
  describe('Network Family Detection', () => {
    it('should return SOLANA network family', () => {
  ...
  describe('Transaction Hash Validation', () => {
    it('should validate correct Solana transaction signatures', () => {
    ...
    it('should reject invalid Solana transaction signatures', () => {
  ...
  describe('Block Explorer URL Generation', () => {
    it('should generate correct block explorer URLs for Solana Devnet', () => {
      const signature =
  ...
  describe('Network Info Retrieval', () => {
...
describe('Blockchain Service Factory Tests', () => {
  let solanaDevnetNetwork: any;
  ...
  describe('Service Creation', () => {
    it('should create SolanaBlockchainService for Solana networks', () => {
